...
Invoke-WebRequest 'https://raw.githubusercontent.com/insightEMEA/ApplicationModernization/master/Hands-on%20lab/lab-files/Database/ContosoInsurance.zip' -OutFile 'C:\ContosoInsurance.zip'
